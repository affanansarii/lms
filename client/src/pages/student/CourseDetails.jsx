    ...
    return courseData ? (
        <>
            <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
                <div className="absolute top-0 left-0 w-full h-[500px] [-z-index:-1] bg-gradient-to-b from-cyan-100/70"></div>
                ...
                <div className="max-w-xl z-10 text-gray-500">
                    ...
                    <div className="flex items-center space-x-2 pt-3 pb-1 text-sm">
                        ...
                        <p className="text-blue-600">
                            ...
                            {courseData.courseRating.length > 1
                                ? "ratings"
                                : "rating"}
                            )
                        </p>
                                            ...
                                            {chapter.chapterContent.map(
                                                (lecture, index) => (
                                                    ...
                                                    >
                                                        ...
                                                        <div className="flex items-center justify-between w-full text-gray-800 text-[15px] leading-[21px] text-xs md:text-[15px] md:leading-[21px]">
                                                            <p>
                                                                {
                    ...
                    <div className="py-20 text-[15px] leading-[21px] md:text-[15px] md:leading-[21px]">
